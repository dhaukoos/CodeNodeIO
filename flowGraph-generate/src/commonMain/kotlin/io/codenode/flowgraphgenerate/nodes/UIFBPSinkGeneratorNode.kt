/*
 * UIFBPSinkGeneratorNode - CodeNode wrapper for UIFBPSinkCodeNodeGenerator
 * License: Apache 2.0
 */
...
import io.codenode.flowgraphgenerate.generator.UIFBPSinkCodeNodeGenerator
import io.codenode.flowgraphgenerate.parser.UIFBPSpec

object UIFBPSinkGeneratorNode : CodeNodeDefinition {
    override val name = "UIFBPSinkGenerator"
    override val category = CodeNodeType.TRANSFORMER
    override val description = "Generates Sink CodeNode from UIFBPSpec"
    ...
    override fun createRuntime(name: String): NodeRuntime {
        return CodeNodeFactory.createContinuousTransformer<Any, String>(
            ...
            transform = { input ->
                ...
                UIFBPSinkCodeNodeGenerator().generate(spec) ?: ""
            }
        )
    }
}
