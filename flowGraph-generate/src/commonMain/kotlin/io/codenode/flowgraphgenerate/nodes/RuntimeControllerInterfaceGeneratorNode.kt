/*
 * RuntimeControllerInterfaceGeneratorNode - CodeNode wrapper for RuntimeControllerInterfaceGenerator
 * License: Apache 2.0
 */
...
object RuntimeControllerInterfaceGeneratorNode : CodeNodeDefinition {
    override val name = "RuntimeControllerInterfaceGenerator"
    override val category = CodeNodeType.TRANSFORMER
    override val description = "Generates runtime ControllerInterface.kt from FlowGraph"
    ...
    override fun createRuntime(name: String): NodeRuntime {
        return CodeNodeFactory.createContinuousTransformer<Any, String>(
            ...
            transform = { input ->
                ...
                RuntimeControllerInterfaceGenerator().generate(config.flowGraph, config.controllerPackage)
            }
        )
    }
}
