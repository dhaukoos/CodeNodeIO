...
// ============================================
// Supporting Data Classes for TDD
// These will be moved to main source when implemented
// ============================================

/**
 * State holder for PropertiesPanel component.
 * This class will be implemented in graphEditor/src/jvmMain/kotlin/ui/PropertiesPanel.kt
 */
data class PropertiesPanelState(
    ...
    companion object {
        fun derivePropertyDefinitions(nodeTypeDef: NodeTypeDefinition): List<PropertyDefinition> {
            // Basic implementation - will be enhanced in actual implementation
            return nodeTypeDef.defaultConfiguration.keys.map { key ->
                PropertyDefinition(
                    name = key,
                    type = PropertyType.STRING, // Will be derived from schema
                    required = false
                )
            }
        }
