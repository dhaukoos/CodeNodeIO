/*
 * In2AnyOut2Runtime - Runtime for any-input nodes with 2 inputs and 2 outputs
...
/**
 * Specialized NodeRuntime for any-input nodes with 2 inputs and 2 outputs.
 *
 ...
 */
class In2AnyOut2Runtime<A : Any, B : Any, U : Any, V : Any>(
    codeNode: CodeNode,
    channelCapacity: Int = Channel.BUFFERED,
    private val initialValue1: A,
    private val initialValue2: B,
    private val process: In2AnyOut2ProcessBlock<A, B, U, V>
