/*
 * In3Out3Runtime - Runtime for nodes with 3 inputs and 3 outputs
...
/**
 * Specialized NodeRuntime for nodes with 3 inputs and 3 outputs.
 *
 ...
 * - Invokes process function that returns ProcessResult3
 ...
 * @param process The processing function that combines inputs and produces ProcessResult3
 */
class In3Out3Runtime<A : Any, B : Any, C : Any, U : Any, V : Any, W : Any>(
    codeNode: CodeNode,
    private val channelCapacity: Int = Channel.BUFFERED,
    private val process: In3Out3ProcessBlock<A, B, C, U, V, W>
    ...
    /**
     * Third output channel for sending data.
     */
        ...
        nodeControlJob = scope.launch {
            try {
                ...
                while (executionState != ExecutionState.IDLE) {
                    ...
                    // Synchronous receive from all three input channels
