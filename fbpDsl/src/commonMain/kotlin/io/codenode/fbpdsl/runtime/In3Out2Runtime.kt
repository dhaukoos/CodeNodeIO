/*
 * In3Out2Runtime - Runtime for nodes with 3 inputs and 2 outputs
...
/**
 * Specialized NodeRuntime for nodes with 3 inputs and 2 outputs.
 *
 ...
 */
class In3Out2Runtime<A : Any, B : Any, C : Any, U : Any, V : Any>(
    codeNode: CodeNode,
    private val channelCapacity: Int = Channel.BUFFERED,
    private val process: In3Out2ProcessBlock<A, B, C, U, V>
