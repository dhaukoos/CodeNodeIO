/*
 * In2Out3Runtime - Runtime for nodes with 2 inputs and 3 outputs
...
/**
 * Specialized NodeRuntime for nodes with 2 inputs and 3 outputs.
 *
 ...
 */
class In2Out3Runtime<A : Any, B : Any, U : Any, V : Any, W : Any>(
    codeNode: CodeNode,
