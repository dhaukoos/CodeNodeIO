/*
 * In1Out3Runtime - Runtime for nodes with 1 input and 3 outputs
 * Manages continuous processing with selective output via ProcessResult3
 * License: Apache 2.0
 */
...
/**
 * Specialized NodeRuntime for nodes with 1 input and 3 outputs.
 *
 ...
 * @param process The processing function that produces ProcessResult3
 */
class In1Out3Runtime<A : Any, U : Any, V : Any, W : Any>(
    codeNode: CodeNode,
